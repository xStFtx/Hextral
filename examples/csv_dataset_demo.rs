use hextral::{
    dataset::{csv::CsvLoader, preprocessing::Preprocessor, FillStrategy},
...
async fn main() -> HextralResult<()> {
    ...
    println!(
        "   Features: {} samples × {} dimensions",
        dataset.metadata.sample_count, dataset.metadata.feature_count
    );
    ...
    println!(
        "   Statistics computed for {} features",
        stats.feature_count
    );
    ...
    println!(
        "   Computed statistics for {} features",
        preprocessing_stats.feature_means.len()
    );
    ...
    println!(
        "   Features: {} × {}",
        regression_dataset.metadata.sample_count, regression_dataset.metadata.feature_count
    );
