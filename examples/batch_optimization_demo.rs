use hextral::{Hextral, ActivationFunction, Optimizer, LossFunction};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    #[cfg(feature = "performance")]
    {
        ...
        println!("Recommended batch size for 128MB memory: {}", recommended_batch_size);
    }
    ...
    let (train_losses, _) = nn_standard.train(
        &train_inputs,
        &train_targets,
        learning_rate,
        epochs,
    ...
    println!("Standard training completed in {:.2}s", standard_time.as_secs_f32());
    ...
    #[cfg(feature = "performance")]
    {
        ...
        let (opt_train_losses, _) = nn_optimized.train_optimized(
            &train_inputs,
            &train_targets,
            learning_rate,
            epochs,
        ...
        println!("Optimized training completed in {:.2}s", optimized_time.as_secs_f32());
        println!("Final training loss: {:.6}", opt_train_losses.last().unwrap());
    ...
    println!("Standard batch prediction ({} samples): {:.3}s", 
             test_size, standard_pred_time.as_secs_f32());
    ...
    #[cfg(feature = "performance")]
    {
        ...
        println!("Optimized batch prediction ({} samples): {:.3}s", 
                 test_size, optimized_pred_time.as_secs_f32());
    ...
    #[cfg(feature = "performance")]
    {
        ...
        println!("Processing large dataset with {} samples...", large_dataset_size);
        ...
        println!("  Total allocations: {}", final_stats.allocation_count - initial_stats.allocation_count);
    }
