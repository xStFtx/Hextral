...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Q1: [{:.1}, {:.1}, {:.1}, {:.1}] -> [{:.3}, {:.3}, {:.3}, {:.3}]",
        input8[0], input8[1], input8[2], input8[3], output8[0], output8[1], output8[2], output8[3]
    );
    println!(
        "Q2: [{:.1}, {:.1}, {:.1}, {:.1}] -> [{:.3}, {:.3}, {:.3}, {:.3}]",
        input8[4], input8[5], input8[6], input8[7], output8[4], output8[5], output8[6], output8[7]
    );

    let norm1 = (output8[0] * output8[0]
        + output8[1] * output8[1]
        + output8[2] * output8[2]
        + output8[3] * output8[3])
        .sqrt();
    let norm2 = (output8[4] * output8[4]
        + output8[5] * output8[5]
        + output8[6] * output8[6]
        + output8[7] * output8[7])
        .sqrt();
